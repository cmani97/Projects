    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="userhome.jsp">Home</a></li>
            ...
            <li><a href="viewattendance.jsp" class="selected">Attendance</a></li>
...
%>
    ...
    <br><center>
        <h2 class="title"><font color="black">Attendance Details</h2></center>
...
<div id="templatemo_main">
    <%
        try {
        PreparedStatement ps = connection.prepareStatement("select * from attendance where studentid = '"+studentid+"'");
    ...
    %>
        ...
        <th><font color="black">Sem</th>
        <th><font color="black">ID Number</th>
        <th><font color="black">Percentage</th>
            </tr>
