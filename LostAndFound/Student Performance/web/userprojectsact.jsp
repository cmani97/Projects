...
<div id="templatemo_main">
    ...
    <tr>
         ...
         <th><font color="black">
                 <textarea rows="4" cols="22" required="" style="text-align: left;direction: ltr;"><%=rs.getString(6)%></textarea></th>
         <th><font color="black">
             <textarea rows="4" cols="22" required="" style="text-align: left;direction: ltr;"><%=rs.getString(8)%></textarea></th>
            <%
                }
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            <br/><center>
                <input type="button" value="Go Back!" onclick="history.go(-1)"></input></center>
