...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            ...
            <li><a href="viewusers.jsp" class="selected">View Students</a></li>
    ...
    <br><center>
        <h2 class="title"><font color="black">View Users & Authorize</h2></center>
...
<div id="templatemo_main">
    ...
    <tr>
         ...
         <th><a href="activate.jsp?studentid=<%=rs1.getString(2)%>">Activate</a></th>
         <th><a href="deactivate.jsp?studentid=<%=rs1.getString(2)%>">Deactivate</a></th> </tr>
            <%
                }
                } catch (Exception e) {
                    e.printStackTrace();
