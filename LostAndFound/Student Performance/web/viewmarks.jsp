    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="userhome.jsp">Home</a></li>
            ...
            <li><a href="viewmarks.jsp" class="selected">Marks</a></li>
...
%>
    ...
    <br><center>
        <h2 class="title"><font color="black">Marks Details</h2></center>
...
<div id="templatemo_main">
    <%
        try {
        PreparedStatement ps = connection.prepareStatement("select * from marks where studentid = '"+studentid+"'");
