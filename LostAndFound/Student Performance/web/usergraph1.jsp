    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
           <li><a href="userhome.jsp">Home</a></li>
            ...
            <li><a href="usergraph.jsp" class="selected">Graph</a></li>
...
<div id="templatemo_main">
    <center><h1><font color="black"> Attendance Graph</font></h1></center>
    <%@ include file="connect.jsp" %>
        ...
        ResultSet rs = null;
           ...
           rs = st.executeQuery("select *from attendance where studentid = '"+studentid+"' ");   
           while(rs.next())
          {
                %>myData["<%=i%>"]=["<%=rs.getString("studentname") %>",<%=rs.getInt("percentage")%>];<% 
            i++;
        }
             %>
    ...
    <br/><br/>
    <center><input type="button" value="Go Back!" onclick="history.go(-1)"></input></center>
