...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            ...
            <li><a href="addmarks.jsp" class="selected">Add Marks</a></li>
...
<div id="templatemo_main">
    <center><h2 class="title"><font color="black"> Add Marks </font></h2></center>
        <div class="clr"></div>
        <center>
        <form action="addmarksact.jsp" method="post" >
