    ...
    <div class="container" id="">
            <div class="" id="Lost">
                <div class="col-lg-11 col-md-11 col-xs-11 col-sm-11 formHead">
                    <h2 align="center">Documents Section</h2>
                </div>
                ...
                <%
                        ...
                        try
                        {
            				...
            				if(SeaData!=null)
            				{
                				searchSql = "select * from documents_details where doc_name like '"+SeaData+"%' or doc_num like '"+SeaData+"%' or person_name like '"+SeaData+"%' or location like '"+SeaData+"%' or date like '"+SeaData+"%'";
            				}
            				else
            				{
            					searchSql = "select * from documents_details";
            				}
            				ResultSet rs = st.executeQuery(searchSql);
            				while(rs.next())            				
            				{
            					String doc_name,doc_num,person_name,location,date,image,path,founder_name,founder_num;
            					doc_name = rs.getString("doc_name").trim();
            					doc_num = rs.getString("doc_num").trim();
            	...
            	<div class="col-lg-11 col-md-11 col-xs-11 col-sm-11" id="LostSec">
                    <div class="col-lg-4 col-md-4 col-xs-11 col-sm-11 lostHead">
                        <h4 align="center"><%=doc_name %></h4>
                        <img src="FoundImges/Documents/<%=image %>" width="">
                    </div>
