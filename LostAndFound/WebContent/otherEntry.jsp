    ...
    <div class="container" id="">
            <div class="" id="Login">
                <div class="col-lg-4 col-md-4 col-sm-11 col-xs-11" id="loginImg">
                    <img src="img/other.png" id="idCard" style="border-radius: 100px;width: 100%">
                </div>
                <div class="col-lg-7 col-md-6 col-sm-11 col-xs-11" id="loginSec">
                <h4 align="center" style="color:red">${otherMessagef}</h4>
                <h4 align="center" style="green">${otherMessages}</h4>
                    <div class="formHead">
                    ...
                    <div class="">
                        <form action="other" method="post"  enctype="multipart/form-data">
                            <div class="">
                                ...
                                <input type="text" placeholder="Enter Name of the item" name="itemName" required><br>
                                
                                <label for="itemNum"><b>Item Number(optional)</b></label><br>
                                <input type="number" placeholder="Enter Number of the item" name="itemNum"><br>
                                
                                <label for="personName"><b>Name on the Item(optional)</b></label><br>
                                <input type="text" placeholder="Enter Name of the Person" name="personName" ><br>
                                ...
                                <label for="image"><b>Upload Image of Item *</b></label><br>
                                ...
                                <input class="submitButton" name="otherSub" type="submit" value="Submit"><br>
                          </div>
                        </form>
                    </div>
                </div>
