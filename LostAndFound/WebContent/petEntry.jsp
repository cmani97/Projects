    ...
    <div class="container" id="">
            <div class="" id="Login">
                <div class="col-lg-4 col-md-4 col-sm-11 col-xs-11" id="loginImg">
                    <img src="img/pets.jpg" id="idCard" style="border-radius: 0px;width: 100%">
                </div>
                <div class="col-lg-7 col-md-6 col-sm-11 col-xs-11" id="loginSec">
                <h4 align="center" style="color:red">${petMessagef}</h4>
                <h4 align="center" style="green">${petMessages}</h4>
                    <div class="formHead">
                    ...
                    <div class="">
                        <form action="pet" method="post"  enctype="multipart/form-data">
                            <div class="">
                                ...
                                <label for="petName"><b>Pet Name *</b></label><br>
                                <input type="text" placeholder="Enter Pet Name" name="petName" required><br>
                                ...
                                <label for="image"><b>Upload Image of Pet *</b></label><br>
                                ...
                                <input class="submitButton" name="petSub" type="submit" value="Submit"><br>
                          </div>
                        </form>
                    </div>
                </div>
