    ...
    <div class="container" id="">
            <div class="" id="Lost">
                <div class="col-lg-11 col-md-11 col-xs-11 col-sm-11 formHead">
                    <h2 align="center">Other Section</h2>
                </div>
                ...
                <%
                        ...
                        try
                        {
            				...
            				if(SeaData!=null)
            				{
                				searchSql = "select * from other_details where item_name like '"+SeaData+"%' or item_num like '"+SeaData+"%' or person_name like '"+SeaData+"%' or location like '"+SeaData+"%' or date like '"+SeaData+"%'";
            				}
            				else
            				{
            					searchSql = "select * from other_details";
            				}
            				ResultSet rs = st.executeQuery(searchSql);
            				while(rs.next())            				
            				{
            					String item_name,item_num,person_name,location,date,image,path,founder_name,founder_num;
            					item_name = rs.getString("item_name").trim();
            					item_num = rs.getString("item_num").trim();
            	...
            	<div class="col-lg-11 col-md-11 col-xs-11 col-sm-11" id="LostSec">
                    <div class="col-lg-4 col-md-4 col-xs-11 col-sm-11 lostHead">
                        <h4 align="center"><%=item_name%></h4>
                        <img src="FoundImges/Others/<%=image %>" width="">
                    </div>
