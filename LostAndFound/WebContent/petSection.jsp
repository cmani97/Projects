            ...
            <div class="" id="Lost">
                ...
                <%
                        ...
                        try
                        {
            				...
            				if(SeaData!=null)
            				{
                				searchSql = "select * from pet_details where pet_name like '"+SeaData+"%' or location like '"+SeaData+"%' or date like '"+SeaData+"%'";
            				}
            				else
            				{
            					searchSql = "select * from pet_details";
            				}
            				ResultSet rs = st.executeQuery(searchSql);
            				while(rs.next())            				
            				{
            					String pet_name,location,date,image,path,founder_name,founder_num;
            					pet_name = rs.getString("pet_name").trim();
            	...
            	<div class="col-lg-11 col-md-11 col-xs-11 col-sm-11" id="LostSec">
                    <div class="col-lg-4 col-md-4 col-xs-11 col-sm-11 lostHead">
                        <h4 align="center"><%=pet_name %></h4>
                        <img src="FoundImges/Pets/<%=image %>" width="">
                    </div>
